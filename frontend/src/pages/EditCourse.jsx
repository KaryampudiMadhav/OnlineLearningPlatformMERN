...
import { BookOpen, Plus, X, Save, Loader } from 'lucide-react';
...
const EditCourse = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.put(`/courses/${id}`, cleanedData);
      ...
      <div className="max-w-5xl mx-auto">
        <div className="bg-slate-800 rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            {/* Same form fields as CreateCourse */}
            ...
            {/* Requirements - Same as CreateCourse */}
